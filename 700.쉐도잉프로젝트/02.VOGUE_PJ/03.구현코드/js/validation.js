    ...
    **************************************/
    $(".eye")
      ...
      .click((e) => {
        ...
        $("#mpw,#mpw2").attr("type", opa == "0.5" ? "text" : "password");
        // 2. CSS 디자인 전환
        $(e.target).css({
...
let pass;
   ...
   $("#btnj").click((e)=>{
    ...
    pass=true;
    // 3. 입력창 blur이벤트 강제발생하기(선택된tgInput에 blur이벤트에 강제 발생)
