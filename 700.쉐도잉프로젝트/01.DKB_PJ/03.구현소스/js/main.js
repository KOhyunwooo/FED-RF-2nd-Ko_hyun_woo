...
/********************************************************** 
 [코드랩핑이란?]
    ...
    실제코드: (()=>{코드})()
    실제코드: (function(){코드})()
    ->이러한 처리방법을 코드의 지역화 또는 코드래핑이라고 부르기도 함
...
(() => {
    ...
    lvData.forEach((v) => {
        ...
        <li>
        <figure>
        <img src="./03.구현소스/images/live_photo/${v.imgName}.jpg" alt="${v.title}">
...
(() => {
    ...
    pData.forEach((v) => {
        ...
        <li>
        <figure>
        <img src="./03.구현소스/images//poster_img/${v.imgName}.jpg" alt="${v.title}">
        <figcaption>${v.title}</figcaption>
        </figure>
        </li>
        `;
    ...
    dkbData.clipData.forEach(v=>{
        ...
        <li>
          <div class="clip-mv-box">
            <img
              src="./03.구현소스/images/clip_img/${v.idx}.jpg"
              alt="${v.subtit}"
            />
          </div>
          <h4>
