        ...
        <>
            <div className="selbx">
                ...
                >
                    <option
                        value="idx"
                        selected={sortCta == "idx" ? true : false}
                    >
                        Recent
                    </option>
                    <option
                        value="tit"
                        selected={sortCta == "tit" ? true : false}
                    >
                        Title
                    </option>
                </select>
            ...
            <table className="dtblview readone">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Attachment</td>
                        <td>
                            {/* 파일정보를 하위컴포넌트에서 상위컴포넌트 변수인 uploadFile에 저장한다!! */}
